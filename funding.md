...
**Atomic order in silicon** spanning from a continuous random network (amorphous) through medium range order (MRO) to randomly oriented crystalline grains (nanocrystalline). See [tricor](https://tricor.readthedocs.io) for more information.
::::
...
::::{div}
<div style="width: 22%; float: right; margin-left: 1em;"><img src="/images/funding/toyota_research_institute.png" alt="TRI" style="width: 100%;" /></div>
...
<div style="width: 24%; float: right; margin-left: 1em;"><img src="/images/funding/microscopy_society_america.png" alt="MSA" style="width: 100%;" /></div>
